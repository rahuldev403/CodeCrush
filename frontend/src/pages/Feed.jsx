          ...
          <Card className="mx-auto max-w-lg border-4 border-primary bg-card shadow-xl">
            ...
            <CardContent className="space-y-4 p-4">
              ...
              {currentProfile.githubLink && currentProfile.githubData ? (
                <div className="border-4 border-accent bg-gradient-to-br from-accent/10 to-accent/5 p-4 shadow-lg">
                  <div className="mb-3 flex items-center gap-3">
                    <img
                      src="/github.png"
                      alt="GitHub"
                      className="h-10 w-10 inline-block rounded border-2 border-accent bg-accent/20 p-1 shadow-[0_0_12px_hsl(var(--accent)/0.6)]"
                      style={{ imageRendering: "pixelated" }}
                    />
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className="h-12 w-12 flex-shrink-0 overflow-hidden border-4 border-accent bg-accent/20"
                      style={{ imageRendering: "pixelated" }}
                    >
                      <img
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <a
                          ...
                          className="inline-flex items-center border-2 border-accent bg-accent px-3 py-1.5 font-mono text-xs font-bold text-accent-foreground shadow-sm"
                          target="_blank"
                          rel="noreferrer"
                        >
                          View →
                      ...
                      <div className="mt-3.5 flex flex-wrap gap-5 font-mono text-sm">
